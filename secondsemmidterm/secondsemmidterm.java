...
public class secondsemmidterm {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("= Midterm Exam Array Operations =");
        System.out.println("\n[A] Sum and Average Elements");
        System.out.println("[B] Smallest and Largest Elements");
        System.out.println("[C] Print Array Contents");
